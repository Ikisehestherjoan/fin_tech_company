...
# =============================================== FOR DEV SCHEMA
banks = '''CREATE TABLE IF NOT EXISTS dev.banks
(
...
cards = '''CREATE TABLE IF NOT EXISTS dev.cards
(
    id integer PRIMARY KEY NOT NULL,
    owner_id integer,
...
CREATE TABLE IF NOT EXISTS dev.cust_verification_status
(
    id integer PRIMARY KEY NOT NULL,
    user_id integer,
...
transaction_status = '''
CREATE TABLE IF NOT EXISTS dev.transaction_status
(
    id integer PRIMARY KEY NOT NULL,
    name VARCHAR(10)
);
...
wallets = '''
CREATE TABLE IF NOT EXISTS dev.wallets
(
    id integer PRIMARY KEY NOT NULL,
    owner_id integer,
...
dev_tables = [banks, cards, cust_verification_status, transaction_status, transactions, users, wallets]
